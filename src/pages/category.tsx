...
const Category = () => {
    ...
    const [Datas, setDatas] = useState([
        ...
        {id:4, description: "독특한 텍스처와 풍부한 맛을 지닌 과자", name : "먹태깡", taste:["짠맛","텁텁한"], category:"과자"},
        {id:5, description: "다양한 맛을 즐길 수 있는 유쾌한 젤리", name : "하리보", taste:["단맛","신맛"], category:"젤리"},
        {id:6, description: "달콤함과 특별한 맛을 선사하는 과자", name : "달고나", taste:["단맛","쓴맛"], category:"과자"},
        {id:7, description: "고소한 맛과 함께 달콤한 감동을 주는 과자", name : "소라과자", taste:["단맛","고소한"], category:"과자"},
        {id:8, description: "달콤함이 가득한 고급스러운 케이크", name : "초코케잌", taste:["단맛","부드러운"], category:"케이크"},
        {id:9, description: "달달하고 매콤한 과자", name : "떡볶이과자", taste:["단맛","매운맛"], category:"과자"},
        {id:10, description: "단짠단짠의 환상의 비율 감자칩", name : "포카칩 초록색", taste:["단맛","짠맛","바삭함"], category:"과자"},
        {
            "id": 11,
