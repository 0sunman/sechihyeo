    ...
    <>
      ...
      <main style={{paddingTop:"51px"}}>
        ...
        <MiniBannerComponent Content={"SECHIHYEO"} Align={"right"}/>
          ...
          <BannerComponent
            imgUrl={"url(//img.cjthemarket.com/images/file/product/160/20210625174933839.png?SF=webp&RS=350x350)"}
          ...
          <BannerComponent
            imgUrl={"url(//img.cjthemarket.com/images/file/product/560/20221228152644244.jpg?SF=webp&RS=350x350)"}
            Title={"입맛을 사로잡는 떡볶이"}
